...
class YOLO(object):
    _defaults = {
        "model_path": './YOLO/weights/trained_weights_final.h5',
        "anchors_path": './YOLO/model_data/yolo_anchors.txt',
        "classes_path": './YOLO/4_CLASS_test_classes.txt',
        "score": 0.3,
        "iou": 0.5,
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            ObjectsList.append([left, top, right, bottom, mid_v, mid_h, label, scores])
...
if __name__ == "__main__":
    yolo = YOLO()
#	path = 'test'
    path = 'C:/Users/folio3/Documents/GitHub/Core/Dataset/Dataset V2/Images/8.jpg'
    for i in [1]:

        #			image = 'E://fyp work//JEPGImages//396.jpg'
        r_image, ObjectsList = yolo.detect_img(path)
        print(ObjectsList)
        # print(ObjectsList)
        # cv2.imshow(image, r_image)
        # cv2.imwrite('results//' + i , r_image)
        break
